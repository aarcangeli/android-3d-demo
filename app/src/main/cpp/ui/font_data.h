...
// 8×8 bitmap font, ASCII 32–127 (96 chars).
// Each entry: 8 bytes, one per row, MSB = leftmost pixel.
// Layout in texture: 16 columns × 6 rows → 128×48 px atlas.
namespace ui {
...
static const uint8_t FONT_8X8[96][8] = {
    ...
    /* 36 '$' */ {0x0C,0x3F,0x06,0x1E,0x30,0x1F,0x06,0x00},
    /* 37 '%' */ {0x63,0x33,0x18,0x0C,0x06,0x33,0x63,0x00},
...
static constexpr int FONT_ATLAS_W     = FONT_COLS * FONT_CELL_W; // 128
static constexpr int FONT_ATLAS_H     = FONT_ROWS * FONT_CELL_H; // 48
